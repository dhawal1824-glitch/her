  ...
  return (
    <section id={id} className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-6 text-center text-white">
        ...
        <h1 className="font-serif text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-bold mb-6 md:mb-8 leading-tight drop-shadow-2xl">
          To My Darling, <br />
        ...
        <p className="text-base md:text-xl font-light max-w-2xl mx-auto opacity-90 leading-relaxed mb-8 md:mb-10 drop-shadow-lg px-4">
        ...
        <div className="flex flex-col items-center gap-4 animate-bounce mt-8 md:mt-12">
